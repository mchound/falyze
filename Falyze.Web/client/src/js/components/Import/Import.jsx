...
module.exports = Lean.createController({
    ...
    onParseClick: function () {
        var cleaned = parseData(this.refs.textarea.getDOMNode().value);
        ...
        return (
            <div data-am-import-form>
                <div className="group mb">
                    ...
                    <input ref="startYear" onChange={this.onStartYearChange} defaultValue="2004" />
                </div>
                <div className="group mb">
                    <label>Raw data</label>
                    <textarea className="parse-area mb" ref="textarea"></textarea>
                    <button data-am-button="green" className="clear" onClick={this.onParseClick} disabled={!state.startYear}>Parse</button>
                </div>                    
            </div>    
        );
    }
